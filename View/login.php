...
<div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
      ...
      <form class="mt-8 space-y-6" action="?a=t&p=home" method="POST">
        ...
        <div>
          <button type="submit" id="myButtonId" name="test" class="group relative flex w-full justify-center rounded-md border border-transparent bg-black py-2 px-4 text-sm font-medium border border-black text-white hover:text-black hover:bg-white focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
