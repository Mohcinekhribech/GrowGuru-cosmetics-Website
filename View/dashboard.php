<?php require_once './public/includes/nav.php' ?>
        ...
        <main class="flex">
            <section class="w-1/6 bg-black h-screen">
                ...
                <a href="?p=dashboard&pd=statistique" class="text-lg text-white font-medium p-2 flex justify-center hover:bg-gray-400 hover:text-white  text-center transition easy-linear max-md:text-sm"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 my-auto">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" />
                  </svg>
                  <span class="max-sm:hidden">statistique</span></a>
                </div>
            </section>
