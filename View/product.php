                ...
                <tbody class="w-full">
                    ...
                    ?>
                            <tr class="focus:outline-none h-20 text-sm leading-none text-gray-800  bg-white   hover:bg-gray-100 ay-900  border-b border-t border-gray-100 -700 ">
                                ...
                                <td class="pl-20">
                                    <a href="?p=dashboard&pd=update&id=<?= $value['productId']?>" class="text-indigo-600 hover:bg-indigo-200 p-2 rounded-lg font-medium transition easy-linear">Update</a>
                                    <a href="?p=dashboard&a=delete&id=<?= $value['productId']?>" class="text-red-600 hover:bg-red-200 p-2 rounded-lg font-medium transition easy-linear">Delete</a>
                                </td>
                            </tr>
                    <?php
                        }
